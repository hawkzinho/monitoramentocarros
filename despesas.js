...
const TIPOS_DESPESA = {
  ...
  oficina:            { label: 'Oficina',               icon: 'hammer',          color: 'icon-orange' },
  salario:            { label: 'Salário',               icon: 'wallet',          color: 'icon-green'  },
  retirada:           { label: 'Retirada',              icon: 'arrow-up-right',  color: 'icon-purple' },
  impostos:           { label: 'Impostos',              icon: 'landmark',        color: 'icon-red'    },
  comissao:           { label: 'Comissão',              icon: 'percent',         color: 'icon-yellow' },
  marketing:          { label: 'Marketing',             icon: 'megaphone',       color: 'icon-blue'   },
  combustivel:        { label: 'Combustível',           icon: 'fuel',            color: 'icon-yellow' },
  vistoria:           { label: 'Vistoria',              icon: 'clipboard-check', color: 'icon-blue'   },
  documentacao:       { label: 'Documentação',          icon: 'file-text',       color: 'icon-purple' },
  sistemas:           { label: 'Sistemas',              icon: 'monitor',         color: 'icon-blue'   },
  terceiros:          { label: 'Terceiros',             icon: 'users',           color: 'icon-gray'   },
  aluguel:            { label: 'Aluguel',               icon: 'building-2',      color: 'icon-purple' },
  internet:           { label: 'Internet',              icon: 'wifi',            color: 'icon-blue'   },
  energia:            { label: 'Energia',               icon: 'zap',             color: 'icon-yellow' },
  agua:               { label: 'Água',                  icon: 'droplets',        color: 'icon-blue'   },
